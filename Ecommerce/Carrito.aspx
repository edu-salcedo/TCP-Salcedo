   ...
   <div class="container-fluid bg-dark">
    <div class="container">
        <nav class="navbar navbar-expand-md navbar-dark">
            <a class="navbar-brand" href="Default.aspx"><span ><img src="img/logo.png" alt="" height ="60" /></span></a>
         ...
         <%foreach(Dominio.Cart item in carrito)
          { %>              
               <tr> 
                   ...
                   <td><%=item.Cantidad
    %><a class="btn btn-primary" href="Carrito.aspx?idmas=<%= item.IdProducto %>" role="button">+</a></td>
