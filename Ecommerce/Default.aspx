...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="carouselExampleControls con" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="CategoryContainer">
            <%   int cont = 0;
                foreach (Dominio.Categoria item in listcat)
                {
                    if (cont < 3)
                    {%>                
                      <div class="CategoryCard" style="width: 18rem;">
                          <a class="hoverCard" href="Catalogo.aspx?nomcat=<%=item.Nombre %>"><span>
